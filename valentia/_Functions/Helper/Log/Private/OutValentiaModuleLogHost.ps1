...
{        
    ...
    (
        ...
        [parameter(
            mandatory = 0,
            position  = 3,
            ParameterSetName = "hidedataAsString")]
        [switch]
        $hidedataAsString,
